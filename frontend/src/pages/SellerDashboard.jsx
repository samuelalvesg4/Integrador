        ...
        <div>
            ...
            <main className="dashboard-container">
                ...
                <div className="dashboard-grid">
                    ...
                    <Link to="/pending-sales" className="dashboard-card">
                        {/* Deixei um badge de notificação como exemplo para o futuro */}
                        <div className="notification-badge">3</div> 
                        <h2>Vendas Pendentes</h2>
                        <p>Confirme novos pedidos para que eles sejam enviados aos clientes.</p>
                    </Link>
                </div>
            </main>
        </div>
